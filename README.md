...
Currently, this codebase is 50% from coding templates, 20% my code, and 5% AI generated code when I get stuck. I will testify that I understand the code of the latter 25%. My today philosophy is that AI can be a learning tool but not should be used as only the learning tool.
