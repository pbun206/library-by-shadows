// Copy pasted from https://github.com/launchbadge/realworld-axum-sqlx/blob/main/src/http/error.rs
...
pub enum AppError {
    ...
    #[display("user may not perform that action")]
    Forbidden,

    /// Return `404 Not Found`
    #[display("request path not found")]
    NotFound,
    ...
    #[display("error in the request body")]
    UnprocessableEntity {
    ...
    #[display("an error occurred with the database")]
    Sqlx(sqlx::Error),
